...
public class ElectionManager {
        ...
        //Start New Code By  me Date: 03/12/2014
        ...
        //End New Code By  me Date: 03/12/2014
        //Atomic reference whose values are updated automatically. -  me
        ...
        public void processRequest(LeaderElection req)  {
                ...
                if (req == null )
                        return;
                //Start New Code to get myId -By  me Date: 03/12/2014
                ...
                if (req.getVote().getNumber() == VoteAction.ELECTION_VALUE) {
                        ...
                        //Start New code to handle the request for Election -By  me Date: 03/09/2014
                        ...
                        if (comparedToMe == -1) {
                                ...
                                //Start New Code :  me Date: 03/18/2014
                                if(myId.length() > 0 ){
                                        // logger.info("<--Inside ElectionManager: processReq-->VoteAction.NOMINATE_VALUE: comparedToMe="+comparedToMe);
                ...
                //End New Code:  me Date:03/18/2014
        }

        //Start New Code  me Date:03/10/2014
        /**
         * Function to generate Election message and send to the respective listening node.
         * @param nodeId
         * @param voteAction
         * By  me Date: 03/10/2014
         */
        public void sendElectionMsg(String nodeId, String desc, VoteAction voteAction) {
                ...
                try {
                        ...
                        if (nodeId.length()>0 && desc.length()>0 && voteAction != null && !hasLeader ){
