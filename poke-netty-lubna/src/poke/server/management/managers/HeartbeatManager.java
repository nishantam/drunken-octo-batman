...
public class HeartbeatManager extends Thread {
        ...
        public void run() {
                ...
                //Start New Code to keep the track of HB and send first automatic message after the first 4 HB send -By  me Date: 03/12/2014
                if(flag){                       
                ...
                while (forever) {
                        try {
                                ...
                                if (outgoingHB.size() > 0) {
                                        // TODO verify known node's status  --  me ??? Need to work on this ! to check whether node connected to node is alive or dead and handle accordingly!
                                        ...
                                        for (HeartbeatData hd : outgoingHB.values()) {
                                                ...
                                                try {
                                                        ...
                                                        //Start New Code to send the fist ElectionStart message after first 4 HB send - By  me Date: 03/22/2014
                                                        count++;
                                                        ...
                                                        //End New Code to send the fist ElectionStart message after first 4 HB send - By  me Date: 03/22/2014
