...
public class ManagementQueue {
        ...
        public static void startup() {
                ...
                iworker.start(); // start method of thread -  me
                oworker = new OutboundMgmtWorker(tgroup, 1);
                oworker.start(); // inbound and outbound threads are initialised -  me
        }
        ...
        public static void enqueueResponse(Management reply, Channel ch) {
                try {
                        ...
                        outbound.put(entry);
                        // me
                        // logger.info("<--Inside ManagementQueue enqResp--> Message put inside outbound Queue entry.req.getElection():" + entry.req.getElection());
                        // me
                } catch (InterruptedException e) {
